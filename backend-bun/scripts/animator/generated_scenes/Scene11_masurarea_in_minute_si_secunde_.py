...
class Scene11_masurarea_in_minute_si_secunde_(Scene):
    def construct(self):
        title = Text("Măsurarea în minute și secunde.", color=BLUE_A)
        ...
        explanation2 = Text("Pentru a converti minute în secunde, înmulțim numărul de minute cu 60.", color=WHITE)
        ...
        example = Text("Exemplu: 5 minute = 5 \\times 60 = 300 secunde", color=WHITE)
        example.next_to(formula2, DOWN)
        self.play(Write(example))
        explanation3 = Text("Pentru a converti secunde în minute, împărțim numărul de secunde la 60.", color=WHITE)
